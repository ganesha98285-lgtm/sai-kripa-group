/* =====================================================================
   ...
   YAHAN SIRF EK CHEEZ BHARNI HAI: neeche SUPABASE_ANON_KEY me apni key
   paste kar dein (quotes ke andar), phir Commit changes daba dein.

   Key kahan milegi:
     Supabase  ->  Settings (gear icon)  ->  API Keys
     ->  "anon" / "publishable" wali key copy karein
